    ...
    return BlocListener<StoryBloc, StoryState>(
      listener: (context, state) {
        if( state is LoadingStory ){
          ...
          Navigator.pop(context);
          modalSuccess(context, 'Thêm thành công', 
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          elevation: 0,
          title:  const TextCustom(text: 'Tin của tôi', fontSize: 19, letterSpacing: .8,),
          leading: IconButton(
            splashRadius: 20,
          ...
          actions: [
            BlocBuilder<StoryBloc, StoryState>(
              builder: (context, state) => TextButton(
                ...
                child: const TextCustom(text: 'Thêm mới', fontSize: 17, color: ColorsCustom.primary)
              ),
            )
          ],
        ),
