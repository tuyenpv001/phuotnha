  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PostBloc, PostState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: const TextCustom(text: 'Bình luận', fontSize: 20, fontWeight: FontWeight.w500, letterSpacing: .8),
          centerTitle: true,
          elevation: 0,
          leading: IconButton(
            splashRadius: 20,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        TextCustom(text: timeago.format(snapshot.data![i].createdAt, locale: 'vi'), fontSize: 14),
                                      ],
                                    )
