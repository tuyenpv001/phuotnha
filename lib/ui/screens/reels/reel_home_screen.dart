...
class ReelHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          const Positioned(
            left: 15,
            top: 30,
            child: TextCustom(text: 'Phuot nha', color: Colors.white, isTitle: true, fontWeight: FontWeight.w600)
          ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const TextCustom(text: 'Tuyển PV', color: Colors.white, fontWeight: FontWeight.w500, fontSize: 14.0),
                    const SizedBox(width: 10.0),
                    Container(
                      ...
                      child: const TextCustom(text: '...', color: Colors.white, fontSize: 13, fontWeight: FontWeight.w500,),
                    )
                  ],
                ),
                const SizedBox(height: 15.0),
                const TextCustom(text: 'Miêu tả', fontSize: 14, color: Colors.white, maxLines: 4, overflow: TextOverflow.ellipsis,),
                const SizedBox(height: 15.0),
                const Row(
                  children:  [
                    Icon(Icons.music_note_rounded, color: Colors.white, size: 15,),
                    SizedBox(width: 5.0),
                    TextCustom(text: 'Tên bài hát', color: Colors.white, fontSize: 14.0,)
                  ],
                )
              ],
            )
      ...
      bottomNavigationBar: const BottomNavigation(index: 3, isReel: true),
    );
  }
}