      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children:  [
              TextCustom(text: 'Tài khoản này là tài khoản riêng tư.', fontWeight: FontWeight.w500),
              TextCustom(text: 'Theo dõi để xem các chuyến đi/ bài viết mới nhất.', color: Colors.grey, fontSize: 16),
            ],
          )
        ],
      ),
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          width: size.width * .5,
          decoration: BoxDecoration(
            color: isFriend == 1 || isPendingFollowers == 1 ? Colors.white : ColorsCustom.primary,
          ...
          ? TextButton(
              ...
              child: TextCustom(
                text: isFriend == 1 ? 'Bạn bè' : 'Kết bạn', 
                fontSize: 20, 
              ...
              children: [
                Column(
                  children: [
                    ...
                    const TextCustom(text: 'Bài viết',  fontSize: 17, color: Colors.grey),
                  ],
                ),
                Column(
                  children: [
                    TextCustom(text: analytics.friends.toString(),  fontSize: 22, fontWeight: FontWeight.w500),
                    const TextCustom(text: 'Bạn bè', fontSize: 17, color: Colors.grey),
                  ],
                ),
                Column(
                  children: [
                    TextCustom(text: analytics.followers.toString(),  fontSize: 22, fontWeight: FontWeight.w500),
                    const TextCustom(text: 'Người theo dõi', fontSize: 17, color: Colors.grey),
                  ],
                ),
