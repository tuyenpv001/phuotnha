                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Hãy miêu tả cảm xúc của bạn',
                                    hintStyle: GoogleFonts.roboto(fontSize: 18)
                                  ),
                                  validator: RequiredValidator(errorText: 'Vui lòng miêu tả cảm xúc của bạn'),
                                ),
                              ),
                            ],
                          ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          BlocBuilder<PostBloc, PostState>(
                            builder: (_, state){
                              if(state.privacyPost == 1) return const TextCustom(text: 'Bất kỳ ai', fontSize: 16);
                              if(state.privacyPost == 2) return const TextCustom(text: 'Chỉ người theo dõi', fontSize: 16);
                              if(state.privacyPost == 3) return const TextCustom(text: 'Chỉ mình tôi', fontSize: 16);
                              return const SizedBox();
                            }
                          ),
